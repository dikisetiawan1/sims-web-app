...
Route::get('/produk/cari', [App\Http\Controllers\DashboardProduk::class, 'cariProduk'])->name('cari-produk');
Route::get('/produk/filter-kategori', [App\Http\Controllers\DashboardProduk::class, 'kategoriProduk'])->name('filter-kategori-produk');
